...
function createTextureSet (
  ...
  function parseFlags (flags, options) {
    ...
    if ('shape' in options) {
      ...
      if (d !== undefined) {
        check$1(d >= 0 && d <= limits.maxTextureSize, 'invalid depth')
      }
    } else {
    ...
    if ('format' in options) {
      ...
      check$1(extensions.ext_texture_norm16 ||
  ...
  function parseTexInfo (info, options) {
    ...
    if ('wrap' in options) {
      ...
      if (typeof wrap === 'string') {
        ...
        if (wrap[2] !== undefined) {
          check$1.parameter(wrap[2], wrapModes)
      ...
      if ('wrapR' in options) {
        ...
        check$1.parameter(optWrapR, wrapModes)
    ...
    for (var i = 0; i < uniforms.length; ++i) {
      ...
      check$1.optional(function () {
        ...
        function checkTexture (target) {
          var ext = Object.fromEntries([
            [GL_TEXTURE_2D$3, '2d'],
            [GL_TEXTURE_3D$1, '3d'],
            [GL_TEXTURE_CUBE_MAP$2, 'Cube']
          ])
